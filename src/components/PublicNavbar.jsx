// Location: src/components/PublicNavbar.jsx
"use client";
...
export default function PublicNavbar({ session }) {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-3 sm:px-6">
          ...
          <Link href="/" className="flex shrink-0 items-center gap-2.5">
            <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-brand-600 text-xs font-bold text-white shadow-sm">
              W2A
            </span>
          ...
          {/* Citizen AI Report Trigger */}
          <button
            type="button"
            onClick={() => setReportOpen(true)}
            className="flex items-center gap-1.5 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-700 hover:bg-emerald-100 transition shadow-sm"
          >
          ...
          {session ? (
            <div className="flex shrink-0 items-center gap-2">
              <Link
                href="/dashboard"
                className="flex items-center gap-1.5 rounded-lg bg-brand-600 px-3 py-2 text-sm font-semibold text-white transition hover:bg-brand-700 sm:px-4 shadow-sm"
              >
      ...
      {/* Gemini Vision Snap & Report Modal */}
      <CitizenReportModal
        isOpen={reportOpen}
